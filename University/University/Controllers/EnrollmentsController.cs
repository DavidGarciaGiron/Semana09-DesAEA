...
namespace University.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EnrollmentID,Grade,StudentID,CourseID")] Enrollment enrollment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EnrollmentID,Grade,StudentID,CourseID")] Enrollment enrollment)
        {
            if (ModelState.IsValid)
            {
